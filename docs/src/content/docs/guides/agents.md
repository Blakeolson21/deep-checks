...
A recovery whose returned branch does not contain a commit it anchored names the holding ref as `preserved_anchor` or `abandoned_anchor`; treat those refs as the last remaining reference to that work.
