...
## [1.46.0](https://github.com/Blakeolson21/no-slop/compare/v1.45.3...v1.46.0) (2026-08-08)


### Features

* add risk assessment, simplify icons, dedupe box rendering ([#7](https://github.com/Blakeolson21/no-slop/issues/7)) ([cec663c](https://github.com/Blakeolson21/no-slop/commit/cec663c27d2c1aff7500b313657ba93c51fb5698))
* Add Windows support for daemon IPC ([#4](https://github.com/Blakeolson21/no-slop/issues/4)) ([53b06e6](https://github.com/Blakeolson21/no-slop/commit/53b06e6e3b220f2fffb5268c18fc68bec7abdd16))
...
* **cli:** add styled output for interactive and non-interactive commands ([#17](https://github.com/Blakeolson21/no-slop/issues/17)) ([06fb84b](https://github.com/Blakeolson21/no-slop/commit/06fb84b8801384ded0754b9b522d916091798817))
...
* **db:** prefer active run for the current branch ([#21](https://github.com/Blakeolson21/no-slop/issues/21)) ([940fd91](https://github.com/Blakeolson21/no-slop/commit/940fd91d36ecae10d8904690cf7f644cd036fdec))
...
* **document:** add document pipeline step and tighten autofix review handling ([#35](https://github.com/Blakeolson21/no-slop/issues/35)) ([61f5319](https://github.com/Blakeolson21/no-slop/commit/61f53194a3e9b335847bef0cc6ebb1c9e0dd47b3))
* generate default global config on first daemon start ([#11](https://github.com/Blakeolson21/no-slop/issues/11)) ([a00aedd](https://github.com/Blakeolson21/no-slop/commit/a00aeddd4f02ecb76a3da144b6028333a13240d8))
...
* initial implementation ([3ff337b](https://github.com/Blakeolson21/no-slop/commit/3ff337b76664dc7fc090eabff8fec937dbfd0d3b))
...
* **makefile:** add daemon start/stop to install ([818ad06](https://github.com/Blakeolson21/no-slop/commit/818ad062ae50f305055903ffbd36bb75fbc52df8))
* **pipeline:** add cancel run support ([ea5056f](https://github.com/Blakeolson21/no-slop/commit/ea5056f261cb8f1765307a7f88dcf810023ced9e))
...
* **pipeline:** add PR summary step and harden findings reporting ([#24](https://github.com/Blakeolson21/no-slop/issues/24)) ([cc78cbf](https://github.com/Blakeolson21/no-slop/commit/cc78cbfdc44ea0da1bdcfef0e69e0bbf5f29fc40))
* **pipeline:** add rebase step and fetch default branch ([a599581](https://github.com/Blakeolson21/no-slop/commit/a599581788dcdb8f08bd52076a213f3a7594f5a7))
...
* **pipeline:** persist and sanitize dismissed findings across review cycles ([#27](https://github.com/Blakeolson21/no-slop/issues/27)) ([92de430](https://github.com/Blakeolson21/no-slop/commit/92de4302ee0fed0a4ca8ea91f95e72bc5e0f15bf))
...
* **pipeline:** use branch base SHA for diffs ([51473e9](https://github.com/Blakeolson21/no-slop/commit/51473e9dab77eb34ce1d9464f6bedf5646e85fd7))
* **pr-url:** add PR URL handling to events and UI ([#20](https://github.com/Blakeolson21/no-slop/issues/20)) ([bded084](https://github.com/Blakeolson21/no-slop/commit/bded084dd3047fd86ee13816b335e01e5553755b))
...
* **rebase:** add scoped auto-fix support for rebase conflicts ([#30](https://github.com/Blakeolson21/no-slop/issues/30)) ([13d379b](https://github.com/Blakeolson21/no-slop/commit/13d379b30cf8444c7d85b40474a502e50fa5280c))
* **rebase:** agent-assisted conflict resolution and execution-only step duration ([#16](https://github.com/Blakeolson21/no-slop/issues/16)) ([3ef3d01](https://github.com/Blakeolson21/no-slop/commit/3ef3d01c0051ecabdff0dea3b75f9fc7514ded75))
* **review:** add configurable auto-fix retries and manual babysit fixes ([#15](https://github.com/Blakeolson21/no-slop/issues/15)) ([3d71a89](https://github.com/Blakeolson21/no-slop/commit/3d71a89d5fe5926029e43383708b1072bcf6efd2))
...
* **tui:** add open PR action ([#29](https://github.com/Blakeolson21/no-slop/issues/29)) ([ae581c8](https://github.com/Blakeolson21/no-slop/commit/ae581c8ee60cea36d2bd9fde519c94234bc03cf6))
...
* **tui:** add responsive layout for wide terminals ([dd0120c](https://github.com/Blakeolson21/no-slop/commit/dd0120c6fbad3aba38a705c73c36b7e90469645d))
...
* **tui:** improve pipeline header and help overlay layout ([3643ab0](https://github.com/Blakeolson21/no-slop/commit/3643ab04fcbdd7bf30da5ae116f07630668434f6))
* **tui:** manage terminal titles across run lifecycle ([#23](https://github.com/Blakeolson21/no-slop/issues/23)) ([c5957d5](https://github.com/Blakeolson21/no-slop/commit/c5957d566fceff074170c83e9a8c76e28b0a8364))
...
* Add configurable grace period before exiting on empty CI checks ([#8](https://github.com/Blakeolson21/no-slop/issues/8)) ([7908189](https://github.com/Blakeolson21/no-slop/commit/7908189ebcc69e48409958662665326617f98074))
...
* **agent:** improve log rendering and add separators ([61e44c0](https://github.com/Blakeolson21/no-slop/commit/61e44c0afc8d809acd4e03f470f86a520f6dabaa))
...
* **agent:** retry when Claude returns no structured output ([#47](https://github.com/Blakeolson21/no-slop/issues/47)) ([6a5784c](https://github.com/Blakeolson21/no-slop/commit/6a5784c266696ec2ec9cd92fe1644db718090ca8))
...
* **babysit:** remove PR comment handling, keep CI-only monitoring ([#12](https://github.com/Blakeolson21/no-slop/issues/12)) ([bc10e51](https://github.com/Blakeolson21/no-slop/commit/bc10e51b15188fbd407088ace370a9a4c063c00c))
* **banner:** add banner line ([#38](https://github.com/Blakeolson21/no-slop/issues/38)) ([a9740ad](https://github.com/Blakeolson21/no-slop/commit/a9740adf20fbcbd02c5b0dbc1af2075c00759d8a))
...
* **config:** enable rebase auto-fix by default ([#48](https://github.com/Blakeolson21/no-slop/issues/48)) ([55a12c5](https://github.com/Blakeolson21/no-slop/commit/55a12c545561dfe57aec628cfd1b6bae49e91e19))
...
* **document:** validate findings payloads and document auto-fix flow ([#43](https://github.com/Blakeolson21/no-slop/issues/43)) ([0ab485e](https://github.com/Blakeolson21/no-slop/commit/0ab485e8b4cd6aa65ca21e995699c3f681373d55))
...
* Fix push step and harden pipeline commit handling ([#3](https://github.com/Blakeolson21/no-slop/issues/3)) ([97330c4](https://github.com/Blakeolson21/no-slop/commit/97330c4678da1c7ca02df40b81713abb6153b190))
* gate human review and make push banner ASCII-safe ([#31](https://github.com/Blakeolson21/no-slop/issues/31)) ([64f0665](https://github.com/Blakeolson21/no-slop/commit/64f066551a9629c44fa5f5c7c4610353aebd3296))
...
* **opencode:** correct text streaming for review snapshots ([#14](https://github.com/Blakeolson21/no-slop/issues/14)) ([e9a22ed](https://github.com/Blakeolson21/no-slop/commit/e9a22ed0779c6cae4d85179ea7da8782cc2dfb87))
...
* **pipeline:** improve risk handling in PR summary and review ([#45](https://github.com/Blakeolson21/no-slop/issues/45)) ([31b9079](https://github.com/Blakeolson21/no-slop/commit/31b9079e6c7668e8c74ef53471f6350aadb52fac))
...
* **pr-title:** enforce conventional commit format on PR titles ([#10](https://github.com/Blakeolson21/no-slop/issues/10)) ([5d4c357](https://github.com/Blakeolson21/no-slop/commit/5d4c357cf6c08e1ccbe0c91ad708e69b4a0dc937))
...
* **pr:** improve risk summary output and remove hardcoded repo link ([#33](https://github.com/Blakeolson21/no-slop/issues/33)) ([b266e9a](https://github.com/Blakeolson21/no-slop/commit/b266e9a631ef9d0746620ee926e18466e5ac1230))
...
* **prsummary:** preserve risk visibility in PR summaries ([#28](https://github.com/Blakeolson21/no-slop/issues/28)) ([b080cd8](https://github.com/Blakeolson21/no-slop/commit/b080cd8fa39d35281d1b1e2e0a6be9f76706e722))
* **pr:** unwrap nested PR body JSON and improve summary handling ([#46](https://github.com/Blakeolson21/no-slop/issues/46)) ([cd3cdc3](https://github.com/Blakeolson21/no-slop/commit/cd3cdc3831a79dc69907fc51d1c4d3110e21f120))
...
* **review:** harden autofix prompt guards and findings sanitization ([#41](https://github.com/Blakeolson21/no-slop/issues/41)) ([31eacf6](https://github.com/Blakeolson21/no-slop/commit/31eacf6b263f30aad27799594db803aca81fca51))
...
* safe guard reverting ([#39](https://github.com/Blakeolson21/no-slop/issues/39)) ([ccdf75e](https://github.com/Blakeolson21/no-slop/commit/ccdf75ed9e5b190b76b238e7d5058adbbb50e14d))
...
* **test-step:** add empty findings handling in test step ([#9](https://github.com/Blakeolson21/no-slop/issues/9)) ([2701d6f](https://github.com/Blakeolson21/no-slop/commit/2701d6ff5240aa767cb5e25465ddf9f4d437823f))
...
* **tui:** clamp babysit pipeline height in stacked layout ([#19](https://github.com/Blakeolson21/no-slop/issues/19)) ([a756d76](https://github.com/Blakeolson21/no-slop/commit/a756d76d8b39f737ef9b049eda08445f55f69d17))
* **tui:** correct timer handling for fixing status ([#44](https://github.com/Blakeolson21/no-slop/issues/44)) ([a59ded4](https://github.com/Blakeolson21/no-slop/commit/a59ded45903671e9f806f12669e5cdc4ea2138ce))
...
* **tui:** preserve and flush review log output ([#18](https://github.com/Blakeolson21/no-slop/issues/18)) ([1bc6004](https://github.com/Blakeolson21/no-slop/commit/1bc6004e31cba391e26b8c817bf185e866148b0a))
* **tui:** preserve help and action bar space with responsive logs ([#13](https://github.com/Blakeolson21/no-slop/issues/13)) ([3e9fb8c](https://github.com/Blakeolson21/no-slop/commit/3e9fb8cc8a352bea3aa7177dadc6d3a0fa27fde2))
...
* **tui:** stabilize babysit panel layout and status context ([#22](https://github.com/Blakeolson21/no-slop/issues/22)) ([7a1df93](https://github.com/Blakeolson21/no-slop/commit/7a1df93dcb25cc6aefa46186e3f57a1c54429533))
* **tui:** update terminal title formatting and tests ([#25](https://github.com/Blakeolson21/no-slop/issues/25)) ([137a27b](https://github.com/Blakeolson21/no-slop/commit/137a27ba7c447b39d10e9fa61a7b6fa8800f1395))
